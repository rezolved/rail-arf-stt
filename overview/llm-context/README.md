...
| [`research-history`](research-history.xml) | 38K | Literature review continuity, methodology discussion, and prior-investigation lookup. |
| [`results-deep-dive`](results-deep-dive.xml) | 17K | Performance analysis, experiment comparison, and result interpretation. |
| [`roadmap`](roadmap.xml) | 6K | Deciding what to do next, prioritizing experiments, and planning follow-up work. |
...
|---|---:|---|
| [`tasks`](type-tasks.xml) | 14K | Complete task data with full descriptions, results summaries, dependencies, and status. |
...
* Size: 9.8 KiB (10,038 bytes; 9,977 chars)
* Estimated tokens: 2,494
...
* Size: 87.2 KiB (89,274 bytes; 88,841 chars)
* Estimated tokens: 22,210
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 150.3 KiB (153,950 bytes; 153,405 chars)
* Estimated tokens: 38,351
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 67.3 KiB (68,938 bytes; 68,532 chars)
* Estimated tokens: 17,133
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 29.7 KiB (30,376 bytes; 30,288 chars)
* Estimated tokens: 7,572
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 42.0 KiB (43,009 bytes; 42,907 chars)
* Estimated tokens: 10,726
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 56.7 KiB (58,020 bytes; 57,694 chars)
* Estimated tokens: 14,423
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 14.5 KiB (14,886 bytes; 14,872 chars)
* Estimated tokens: 3,718
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 45.1 KiB (46,223 bytes; 46,073 chars)
* Estimated tokens: 11,518
* Fits: 131k-class, 200k-class, 1M-class
...
* Size: 1.2 KiB (1,220 bytes; 1,220 chars)
