...
These predictions capture the per-instance output of Whisper turbo (~809M parameters, faster-whisper INT8) on the gold-92
...
Whisper turbo (~809M parameters, faster-whisper INT8) run locally via `faster-whisper` (CTranslate2 INT8 quantization, CPU
