...
Streaming simulation:
  ...
  - Biasing: keyword prompt injection — t0007 best variant
"""
...
from tasks.t0012_whisper_parakeet_granite_streaming.code.paths import GRANITE_STREAMING_TRANSCRIPTS
...
def transcribe_clip(
    model: object, processor: object, wav: torch.Tensor, prompt: str, device: str
) -> str:
