...
Copied from tasks/t0014_granite_short_clip_robustness/code/hallucination_detector.py
and adapted to use t0015 constants.
...
from tasks.t0017_parakeet_biasing_buffer_replacement.code.constants import BOH_FALLBACK_PATTERNS
